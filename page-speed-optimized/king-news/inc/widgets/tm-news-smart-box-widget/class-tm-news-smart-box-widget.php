...
class KING_NEWS_News_Smart_Box_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		...
		$this->settings = array(
			'title' => array(
				'type'  => 'text',
				'value' => esc_html__( 'News Smart Box', 'king_news' ),
			...
			'layout_type' => array(
				...
				'options'			=> array(
					'layout_type_1' => array(
						'label'		=> esc_html__( 'Layout type 1', 'king_news' ),
						'img_src'	=> KING_NEWS_THEME_URI . '/assets/images/admin/widgets/news-smart-box/news-smart-box-layout-1.svg',
					),
					'layout_type_2' => array(
						'label'		=> esc_html__( 'Layout type 2', 'king_news' ),
						'img_src'	=> KING_NEWS_THEME_URI . '/assets/images/admin/widgets/news-smart-box/news-smart-box-layout-2.svg',
					),
					'layout_type_3' => array(
						'label'		=> esc_html__( 'Layout type 3', 'king_news' ),
						'img_src'	=> KING_NEWS_THEME_URI . '/assets/images/admin/widgets/news-smart-box/news-smart-box-layout-3.svg',
					),
				),
				'label'				=> esc_html__( 'Choose layout type', 'king_news' ),
			),
			'terms_type' => array(
				'type'				=> 'radio',
				'value'				=> 'category',
			...
			'categories' => array(
				...
				'label' => esc_html__( 'Select category', 'king_news' ),
				'multiple' => true,
				'placeholder' => esc_html__( 'Select categories', 'king_news' ),
			),
			'current_tag' => array(
				'type' => 'select',
				'value' => '',
				...
				'options' => false,
				'label' => esc_html__( 'Select tag', 'king_news' ),
	...
	public function get_smart_box_loop( $posts_query ) {
		...
		if ( $posts_query->have_posts() ) {
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$placeholder_args = apply_filters( 'king_news_news_smart_box_placeholder_args',
					array(
						'width'			=> 560,
						'height'		=> 350,
						'background'	=> '000',
				...
				$image_size = apply_filters( 'king_news_carousel_image_size', $image_size );
	...
	public function get_image( $id, $size, $placeholder_attr, $only_url = false ) {
		...
		$default_placeholder_attr = apply_filters( 'king_news_news_smart_box_placeholder_default_args',
			array(
				'width'			=> 900,
				'height'		=> 500,
				'background'	=> '000',
...
function tm_register_news_smart_box_widgets() {
	register_widget( 'KING_NEWS_News_Smart_Box_Widget' );
}